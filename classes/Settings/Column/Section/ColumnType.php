...
class AC_Settings_Column_Section_ColumnType extends AC_Settings_Column_Section {
	...
	public function __construct() {
		...
		$this->set_description( __( 'Choose a column type.', 'codepress-admin-columns' ) . '<em>' . __( 'Type', 'codepress-admin-columns' ) . ': ' . $type . '</em><em>' . __( 'Name', 'codepress-admin-columns' ) . ': ' . $name . '</em>' );
